...
const CreateAssignment = () => {
  ...
  const handleAdd = (e) => {
    ...
    // console.log(description,Tittle);
    console.log(Tittle, level, Date, description, Marks, photo);
    // const fullForm = {
    //   name,
    //   brand_name,
    //   type,
      ...
      >
        ...
        <div className=" flex flex-col lg:flex-row gap-12 mb-10">
          ...
          <label className="input-group md:w-4/5 lg:w-1/2 mx-auto lg:input-group-md">
            ...
            <select value={level} onChange={handleChangePage} className="input input-bordered w-full">
